...
// .wrangler/tmp/bundle-VKv7kw/checked-fetch.js
      ...
      return jsonResponse(
        {
          ...
          detail: {
            ...
            hint: "Cloudflare: Workers \u2192 dashboardhu \u2192 Settings \u2192 Variables (GAS_WEBAPP_URL + secret GAS_SECRET). Local: .dev.vars na raiz. Ou VITE_GAS_SECRET no .env (s\xF3 debug)."
          }
        },
        500
      );
...
// .wrangler/tmp/bundle-VKv7kw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-VKv7kw/middleware-loader.entry.ts
